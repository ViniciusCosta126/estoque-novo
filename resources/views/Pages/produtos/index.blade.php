<x-layout title="Produtos">
    ...
    <div>
        <button class="btn btn-success mb-2" data-bs-toggle="modal" data-bs-target="#criarProduto">Incluir novo
            Produto
        </button>
    </div>
                ...
                @foreach ($produtos as $produto)
                    <tr>
                        ...
                        <td class="d-flex">
                            ...
                            <form action="{{ route('produtos.destroy', $produto->id) }}" method="POST" class="ms-1">
                                @csrf
                                @method('DELETE')
